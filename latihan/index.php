...
<body>
    <img src="https://erwin756.files.wordpress.com/2016/07/fakultas-ilmu-komputer.png" alt="image" style="width:100px; float:right; height: 100px;">
</body>
</html>
<?php
...
echo "<span class='glyphicon glyphicon-plus'></span>Buat baru";
echo "</a>";
echo "</div>";
