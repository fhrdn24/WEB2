...
if($_POST)
{
    ...
    // if unable to edit user
        ...
        echo "<div class=\"alert alert-danger alert-dismissable\">";
            ...
            echo "Tidak dapat mengedit pengguna!.";
        echo "</div>";
    }
}
?>
    ...
    <form action='edit.php?id=<?php echo $id; ?>' method='post'>
        ...
        <table class='table table-hover table-responsive table-bordered'>
            ...
            <tr>
                <td>Nama depan</td>
                <td><input type='text' name='firstname' value='<?php echo $user->firstname;?>' class='form-control' placeholder="masukan Nama Depan" required></td>
            </tr>

            <tr>
                <td>Nama belakang</td>
                <td><input type='text' name='lastname' value='<?php echo $user->lastname;?>' class='form-control' placeholder="masukan Nama belakang" required></td>
            </tr>

            <tr>
                <td>Email</td>
                <td><input type='email' name='email' value='<?php echo $user->email;?>' class='form-control' placeholder="masukan alamat Email" required></td>
            </tr>

            <tr>
                <td>No Handphone</td>
                <td><input type='number' name='mobile' value='<?php echo $user->mobile;?>' class='form-control' placeholder="masukan no Handphone" required></td>
            </tr>
